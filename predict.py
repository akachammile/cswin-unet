...
if __name__ == "__main__":
    ...
    name_classes = ["background", "leaf", "frog_eye_spot", "scab", "rust", "alternaria_leaf_spot"]
    # ----------------------------------------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        # img = input(r'D:\aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\unet-pytorch-main\VOCdevkit\VOC2007\JPEGImages\Alternari350_labelme.jpg')

        image = Image.open(r'D:\aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\unet-pytorch-main\VOCdevkit\VOC2007\JPEGImages\Alternari350_labelme.jpg')
