...
from nets.Sunet import SwinUnet
# from nets.unet import vit_base_patch16_224 as SwinUnet
...
if __name__ == "__main__":
    ...
    model = SwinUnet(num_classes=num_classes).train()

    input_size = (1, 3, 224, 224)
    gflops = calculate_gflops(model, input_size)
    print('gflopshhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh')
    print("模型的GFlops为:", gflops)
    print('gflopshhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh')
    total_params = sum(p.numel() for p in model.parameters())
    print('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')
    print("The total params of the model is: {} ".format(total_params))
